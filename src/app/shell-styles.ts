...
export const SHELL_NAV_ITEM =
  "relative flex items-center rounded-[10px] text-zinc-600 transition-[transform,background-color,box-shadow,color] duration-150 ease-out active:scale-[0.98] motion-reduce:active:scale-100";
