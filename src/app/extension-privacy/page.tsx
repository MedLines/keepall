        ...
        <article className="mx-auto mt-12 w-full max-w-3xl pb-16 sm:mt-16">
          ...
          <div className="mt-8 space-y-6 text-sm leading-7 text-text-secondary">
            ...
            <section>
              ...
              <p className="mt-2">The extension passes the capture to the Keepall web app running in your browser. Keepall saves your library in that browser profile&apos;s local IndexedDB. You do not need a Keepall account, and the extension does not sync your library to a cloud account. For link saves, the extension temporarily holds a pending capture in Chrome extension storage so a failed save can be retried. Pending link captures expire after ten minutes and are removed at the next cleanup; confirmed captures are removed immediately. Image bytes are passed to the local library without being stored in extension storage. Selected text is passed directly to the local library without being kept in extension storage. Your selected Keepall address and extension appearance preference remain in extension storage until you change them or remove the extension.</p>
            </section>
            <section>
